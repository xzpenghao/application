...
public interface OuterBackFeign {
    ...
    ObjectRestResponse<List<SJ_Exception_Record>> DealRecieveFromOuter8(SJ_Exception_Record exc);

    //插入访问异常信息
    @RequestMapping(value = "/DealRecieveFromOuter9", method = RequestMethod.POST,consumes = "application/json")
    public ObjectRestResponse<String> DealRecieveFromOuter9(SJ_Exception_Record exc);
