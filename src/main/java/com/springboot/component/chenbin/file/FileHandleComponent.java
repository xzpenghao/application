...
@Slf4j
@Component
public class FileHandleComponent {

    public String uploadFileLocal(MultipartFile file,String processId,String basePath){
    ...
    public String uploadBytesToFileLocal(String dirPath,String fileName, byte[] bytes) throws IOException {
        String filePath = "";
        if(bytes!=null) {
