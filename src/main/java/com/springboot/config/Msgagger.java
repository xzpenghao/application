...
public class Msgagger {
    ...
    public final static String BDCDYXXSJSERVICE_CODE="MortgageCertificateService";
    public final static String JYTHSERVICE_CODE="TransactionContractService";
    ...
    public final static String DYHTSERVICE_CODE="MortgageContractService";
